...
public final class Radiation {
		...
		private static String dupCond = "datetime==pDatetime && label==pLabel && valuetype==pValuetype && lat==pLat && lon==pLon && radiovalue==pRadiovalue";			
		private static String dupDeclare = "java.util.Date pDatetime,String pLabel,int pValuetype,double pLat,double pLon,double pRadiovalue";			
